    ...
    return (
        <header className="absolute md:relative left-0 top-0 w-full z-[111]">
            <div>
                ...
                <div className="wraper bg-navbar pt-[5px] px-[10px] relative before:absolute before:w-full before:h-[1px] before:bg-[rgba(255,255,255,.07)] before:bottom-0 before:left-0 before:content-['']">
            ...
            <div className="relative">
                ...
                <div className="wraper bg-navbar px-[10px]">
