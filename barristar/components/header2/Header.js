...
const Header2 = (props) => {
    ...
    return (
        <header className="absolute left-0 top-0 w-full z-[111] lg:relative">
            ...
            <div className="bg-navbar pt-[5px] relative before:absolute before:w-full before:h-[1px] before:bg-[#79787a] before:bottom-0 before:left-0 before:content-['']">
            ...
            <div className="wpo-site-header bg-[rgba(255,255,255,.05)] lg:bg-navbar] relative  border-b border-[rgba(255,255,255,.07)]">
                <div className="wraper">
